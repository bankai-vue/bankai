...
import { BankaiContainer, BankaiText } from '@bankai-vue/core';
...
<template>
  <article class="doc">
    ...
    <BankaiText as="p" size="lg" tone="muted">
      ...
      <code>fluid</code>. Reusable anywhere — a Card, a section, a hero — not once per route. The
      width layer of App › Layout › Page › Container (SPEC §5.6); it is not a landmark and never
      renders its own <code>&lt;main&gt;</code>.
    </BankaiText>
    ...
    <section class="doc-section">
      ...
      <BankaiText size="sm" tone="muted">
        The centered width is intrinsic: <code>max-inline-size</code> resolves against the
        containing block, and <code>margin-inline: auto</code> centers within it. So a container
        caps at its max-width when there is room (bars on the sides) and
        ...
        it — the case a viewport breakpoint gets wrong. <code>fluid</code> is for the opposite
    ...
    <section class="doc-section">
      ...
      <BankaiText size="sm" tone="muted">
        ...
        (no selector needed) — globally on <code>:root</code>, or locally on any ancestor.
      </BankaiText>

  ...
  <BankaiPage>
    <BankaiFlex as="article" direction="column" gap="12">
      ...
      <BankaiText as="p" size="lg" tone="muted">
        ...
        yours to control with plain CSS against <BankaiCode>.bankai-layout</BankaiCode> — there is
      ...
      <section class="doc-section">
        ...
        <BankaiText size="sm" tone="muted">
          ...
          the main content. Absent regions collapse their track, so a header-less or sidebar-less
          app needs no override.
        </BankaiText>
      ...
      <section class="doc-section">
        ...
        <BankaiText size="sm" tone="muted">
          ...
          >, <BankaiCode>min-block-size</BankaiCode>) and named areas rather than physical
          left/right, and CSS Grid lays columns along the inline axis — so under
        ...
        <BankaiText size="sm" tone="muted">
          ...
          <BankaiCode>position: fixed</BankaiCode> needed); a sticky header is a one-liner. To let
        ...
        <BankaiText size="sm" tone="muted">
          Utilities win by ordinary specificity: <BankaiCode>col-span-*</BankaiCode>/<BankaiCode
            >row-span-*</BankaiCode
          >
          on children and <BankaiCode>grid-cols-*</BankaiCode>/<BankaiCode>grid-rows-*</BankaiCode>
          on the root all override the theme. One caveat — the theme also sets
          <BankaiCode>grid-template-areas</BankaiCode>, which governs where the named regions land
          and implies its own column count. Overriding only

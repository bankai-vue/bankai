...
<template>
  <article class="doc">
    ...
    <BankaiText as="p" size="lg" tone="muted">
      A standalone <BankaiCode>&lt;aside&gt;</BankaiCode> complementary region — a side rail beside
      the main content, typically a sidebar nav. The native element carries the
    ...
    <section class="doc-section">
      ...
      <BankaiText size="sm" tone="muted">
        ...
        <BankaiCode>#sidebar</BankaiCode> slot: <BankaiCode>BankaiLayout</BankaiCode> already emits
        an <BankaiCode>&lt;aside&gt;</BankaiCode> for that slot, so a nested

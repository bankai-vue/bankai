  ...
  <article class="doc">
    ...
    <section class="doc-section">
      ...
      <BankaiText as="p" size="sm" tone="muted">
        ...
        document outline screen-reader users navigate by — so <BankaiCode>level</BankaiCode> has no
        default and must be stated. Pick it by the heading's place in the page hierarchy (don't skip
        levels), not by how big you want it to look.
      </BankaiText>
      <BankaiText as="p" size="sm" tone="muted">
        Decoupling the visual size from the semantic level (an
        <BankaiCode>&lt;h2&gt;</BankaiCode> styled like an <BankaiCode>&lt;h1&gt;</BankaiCode>, the
        proper fix for wanting a size without skipping a level) is planned as a future
    ...
    <section class="doc-section">
      ...
      <BankaiText as="p" size="sm" tone="muted">
        ...
        <BankaiCode>:root</BankaiCode>), so you retune one size, its line height, the shared weight,
        or the color by overriding a single property — no selector, no

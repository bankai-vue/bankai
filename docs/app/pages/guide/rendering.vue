...
<template>
  <article class="doc">
    ...
    <BankaiText as="p" size="lg" tone="muted">
      ...
      hydration model, how <BankaiCode>BankaiLink</BankaiCode> finds your router, and the one config
      value you should set when you server-render.
    </BankaiText>
    ...
    <section class="doc-section">
      ...
      <BankaiText as="p" tone="muted">
        ...
        <BankaiCode>BankaiLink</BankaiCode>'s <BankaiCode>data-bankai-external</BankaiCode> flag: on
        the server and the first client render it is computed from
    ...
    <section class="doc-section">
      ...
      <ol class="doc-list">
        ...
        <li>a globally-registered <BankaiCode>RouterLink</BankaiCode> (a plain vue-router app);</li>
      ...
      <BankaiText as="p" tone="muted">
        ...
        <BankaiCode>vue-router</BankaiCode> and Nuxt register these — so core never imports a router
        and stays dependency-free. A <BankaiCode>string</BankaiCode>
      ...
      <BankaiText as="p" tone="muted">
        By default <BankaiCode>to</BankaiCode> is a router-agnostic type. If you use vue-router, add
        the types entry to your <BankaiCode>tsconfig.json</BankaiCode> to type it as vue-router's
        <BankaiCode>RouteLocationRaw</BankaiCode>. It is an opt-in augmentation, so a router-free
    ...
    <section class="doc-section">
      ...
      <BankaiText as="p" tone="muted">
        ...
        <BankaiCode>window</BankaiCode> — and under SSG there is no request at all — so the current
        origin is not knowable at render time.
      </BankaiText>
      <BankaiText as="p" tone="muted">
        Set <BankaiCode>linkOrigin</BankaiCode> to your canonical site origin so the check is
        accurate and identical on server and client. A client-only SPA can leave it unset — it falls
        back to <BankaiCode>window.location</BankaiCode> after hydration; with no origin available
        at all, any absolute <BankaiCode>http(s)</BankaiCode> URL is treated as external.
      </BankaiText>
